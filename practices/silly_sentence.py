...
print(name+' fell down the stairs and got head trama so he '+verb+' to the docters office the docter perscribed '+number+' '+item+' a day for a year')
print('thanks for trying my mad lib (:')